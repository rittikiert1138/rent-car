...
const Sidenav = (props: PropMain) => {
  ...
  return (
    <div className={classNames(" h-[100vh] bg-white  fixed top-0 left-0 z-20 shadow-sm overflow-hidden", props.toggle ? "w-[300px]" : "w-[0px]", "md:w-[300px] w-[0px]")}>
      <div className="w-full h-[70px]  pt-3">
        <img src="/images/Head-logo.png" className="h-10 block mx-auto " />
      </div>
      {props.toggle ? (
        <div className="panel-mobile">
          <div className="w-[300px] h-[100vh] bg-white opacity-100 px-3">
            <div className="w-full h-[70px]  pt-3">
              <img src="/images/Head-logo.png" className="h-10 block mx-auto " />
            </div>
            <ul>
